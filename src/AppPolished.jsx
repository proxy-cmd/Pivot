...
export default function AppPolished() {
  ...
  function reset() { localStorage.removeItem('pivot-active-dataset'); setData(null); setOverview(null); setAnalyses([]); setPreview(null); setMessages([]); setResult(null); setPage('Overview'); setMessage('') }
