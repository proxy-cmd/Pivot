...
export default function AppPolished() {
  ...
  else if (page === 'Ask Pivot') content = <AnalystV3 data={data} question={question} setQuestion={setQuestion} messages={messages} ask={ask} busy={chatBusy} attachContext={attachContext} />
