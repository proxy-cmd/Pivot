...
function AnalystV3({ data, question, setQuestion, messages, ask, busy, attachContext }) {
  const userInitials = initials(readJson('pivot-personal-profile'))
...
export default function AppPolished() {
  ...
  else if (page === 'AI Analyst') content = <AnalystV3 data={data} question={question} setQuestion={setQuestion} messages={messages} ask={ask} busy={chatBusy} attachContext={attachContext} />
